...
echo " Tools Khusus Dari Rahmad Mudzaki "
echo "sebagai tanda kasih sayang ini Saya Tambahkan Tools Hack FB Dan IG Yang Kamu Kepengen Dari Dulu :) " | lolcat
echo "1.hack fb target " | lolcat
echo "2.hack ig (Soory Eror) " | lolcat
